...
namespace LaserHit2D
{
    public class TargetManager : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject m_WinButton;
        ...
        void Awake()
        {
            ...
            // Aseguramos que el botón empiece oculto
            if (m_WinButton != null)
                m_WinButton.SetActive(false);
        ...
        public void CheckAllTargetsHit()
        {
            ...
            if (m_WinButton != null)
                m_WinButton.SetActive(true);   // ← aquí aparece el botón
